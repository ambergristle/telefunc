import{u as l,o as s,a}from"../chunks/chunk--8-QCjR9.js";import{j as e}from"../chunks/chunk-oyxVpqMS.js";import{L as t}from"../chunks/chunk-B55L2fB-.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const i=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(n){const r={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Environment"}),": server."]}),`
...
`,e.jsxs(r.li,{children:["When a telefunction throws an error that is not ",e.jsx(r.code,{children:"Abort()"}),". (In other words, the telefunction has a bug.)"]}),`
`,e.jsx(r.li,{children:"When Telefunc throws an error. (In other words, Telefunc has a bug)."}),`
`]}),`
`,e.jsxs(r.blockquote,{children:[`
`,e.jsxs(r.p,{children:[e.jsx(r.code,{children:"throw Abort()"})," does ",e.jsx(r.em,{children:"not"})," trigger ",e.jsx(r.code,{children:"onBug()"}),". It's expected that ",e.jsx(r.code,{children:"throw Abort()"})," may be called (when some third-party erroneously calls a telefunction). In other words, ",e.jsx(r.code,{children:"throw Abort()"})," isn't a bug."]}),`
`]}),`
