...
as discussed in `,e.jsx(t,{href:"/event-based"}),`,
...
`,e.jsxs(n.p,{children:["But you can as well achieve a decoupled frontend-backend development with RPC by using what we call a ",e.jsx(n.em,{children:"Telefunc Server"}),"."]}),`
`,e.jsx("h2",{id:"telefunc-server",children:"Telefunc Server"}),`
`,e.jsx(n.p,{children:`You usually install Telefunc as a Node.js server middleware.
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"  }"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(n.p,{children:["If you change your ",e.jsx(n.code,{children:"<TodoList>"}),` component to also show the to-do items' creation date,
then you need to change the SQL query of your `,e.jsx(n.code,{children:"getInitialData()"})," telefunction from ",e.jsx(n.code,{children:"SELECT id, text"})," to ",e.jsx(n.code,{children:"SELECT id, text, created_at"}),"."]}),`
`,e.jsx(n.p,{children:"This means that the frontend developers need to make changes to the Node.js server and re-deploy it."}),`
`,e.jsx(n.p,{children:`If you are a small team of full-stack developers, then such frontend-backend coupling is not a problem.
But, as you grow, you may want to have a frontend team that develops independently of a backend team.`}),`
`,e.jsx(n.p,{children:"You can achieve a decoupling by using a Telefunc Server: a dedicated Node.js server with the sole purpose of serving telefunctions."}),`
...
`,e.jsxs(n.p,{children:["You can develop multiple frontends as well with RPC by having one ",e.jsx(n.a,{href:"#telefunc-server",children:"Telefunc Server"})," per frontend."]}),`
...
`,e.jsx(n.p,{children:`RPC enables your frontend to directly use ORM/SQL queries which is not only a fundamentally simpler approach,
...
`,e.jsx(n.p,{children:`On the other hand, you need GraphQL/REST if you need to
give third parties access to your database.`}),`
`,e.jsx(n.p,{children:"Also, using a GraphQL API can be a crucial strategy for very large companies with very complex databases."}),`
